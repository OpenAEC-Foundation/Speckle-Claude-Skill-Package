...
export function registerProjectTools(
  ...
  server.tool(
    ...
    "List Speckle projects accessible to the authenticated user. Returns project name, ID, description, visibility, and model count.",
    {
      limit: z
        .number()
        .min(1)
  ...
  server.tool(
    "speckle_get_project",
    "Get detailed information about a specific Speckle project including team members and models",
    {
  ...
  server.tool(
    ...
    "Search Speckle projects by name or description",
    {
