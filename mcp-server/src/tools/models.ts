...
export function registerModelTools(
  ...
  server.tool(
    "speckle_list_models",
    "List models (branches) in a Speckle project. Returns model name, ID, version count, and author.",
    {
  ...
  server.tool(
    "speckle_get_model",
    "Get detailed information about a specific model including its recent versions",
    {
      projectId: z.string().describe("The project ID"),
  ...
  server.tool(
    ...
    "Create a new model (branch) in a Speckle project",
    {
      projectId: z.string().describe("The project ID"),
