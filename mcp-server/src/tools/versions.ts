...
export function registerVersionTools(
  ...
  server.tool(
    ...
    "List versions (commits) of a model in a Speckle project. Returns version message, ID, author, source application, and referenced object ID.",
    {
  ...
  server.tool(
    "speckle_get_version",
    "Get detailed information about a specific version (commit) including its model and referenced object",
    {
      projectId: z.string().describe("The project ID"),
