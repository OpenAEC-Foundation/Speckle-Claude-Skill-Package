# Speckle Skill Package — WAY OF WORK
...
- Map the Speckle technology landscape
- Identify all API surfaces, SDKs, connectors, and integration points
...
- Research documents:
  - `vooronderzoek-speckle-object-model.md` — Base object model and transport
  - `vooronderzoek-speckle-api.md` — GraphQL API and REST endpoints
  - `vooronderzoek-speckle-sdks.md` — SpecklePy and Speckle Sharp
  - `vooronderzoek-speckle-connectors.md` — Revit, Rhino, Grasshopper, Blender connectors
  - `vooronderzoek-speckle-automate.md` — Automate platform and functions
...
- Focus on exact API patterns, SDK methods, connector behaviors
...
- Functional: test API patterns using skills
...
```
skills/source/speckle-{category}/{speckle-{category}-{topic}}/
├── SKILL.md              # Main skill (< 500 lines, YAML frontmatter)
└── references/
    ├── methods.md         # API methods and SDK functions
...
## Essential Patterns
[Core API/SDK patterns with examples]
